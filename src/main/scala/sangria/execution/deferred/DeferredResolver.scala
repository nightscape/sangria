...
object DeferredResolver {
  ...
  def fetchers[Ctx](fetchers: Fetcher[Ctx, _, _, _, _]*): DeferredResolver[Ctx] =
    new FetcherBasedDeferredResolver[Ctx](fetchers.toVector, None)

  def fetchersWithFallback[Ctx](fallback: DeferredResolver[Ctx], fetchers: Fetcher[Ctx, _, _, _, _]*): DeferredResolver[Ctx] =
